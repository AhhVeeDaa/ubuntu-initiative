                    ...
                    <div className="max-w-2xl mx-auto">
                        <div className="text-center mb-12">
                            ...
                            <div className="flex justify-center">
                                <a
                                    href="https://www.appsheet.com/start/c543bcd2-5cbf-43cc-9080-8d9b78f8e611"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center px-4 py-2 border border-[hsl(var(--primary))] text-[hsl(var(--primary))] rounded-full hover:bg-[hsl(var(--primary))]/10 transition-colors text-sm font-medium"
                                >
