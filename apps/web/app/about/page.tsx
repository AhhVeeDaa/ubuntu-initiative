        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              UbuntuHub is the operational transparency platform of the Ubuntu Initiative—providing 
              real-time monitoring, policy tracking, and institutional coordination infrastructure for 
              Africa's sovereign AI development.
            </p>
          </div>
