-- Custom migration to apply Policy Agent V2 schema
-- Pre-cleans conflicting tables from previous migrations

DROP TABLE IF EXISTS public.policy_updates CASCADE;
DROP TABLE IF EXISTS public.agent_audit_log CASCADE;
DROP TABLE IF EXISTS public.approval_queue CASCADE;
DROP TABLE IF EXISTS public.policy_corrections CASCADE;
